...
namespace SpeederRunGame
{
    public class TokenRewardManager : MonoBehaviour
    {
        ...
        private string TokenERC20Address = "0xa3b4E239Daf08E44Ec5Dc5Cc2588037b086b2bBc";
        private string rewardERC1155Address = "0x228AfB48543514EB20A57b7D5901D4dd3f5aF5FF";
        private string leaderboardAddress = "0xFc75dA8017232B3db45CFa74B271d64a220A76f8";
        ...
        public async void GetTokenBalance()
        {
            ...
            var contract = ThirdwebManager.Instance.SDK.GetContract(TokenERC20Address);
        ...
        {
            Address = await ThirdwebManager.Instance.SDK.Wallet.GetAddress();
            var contract = ThirdwebManager.Instance.SDK.GetContract(rewardERC1155Address);
